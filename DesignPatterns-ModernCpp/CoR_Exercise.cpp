...
//	cout << "goblin 1: " << "A:" << goblin.get_attack() << ", D : " << goblin.get_defense() << endl;
//
//	cout << "Adding a second goblin, now they should be 1/2...\n";
//	Goblin goblin2{ game };
//	game.creatures.push_back(&goblin2);
//	cout << "goblin 1: " << "A:" << goblin.get_attack() << ", D : " << goblin.get_defense() << endl;
//	cout << "goblin 2: " << "A:" << goblin2.get_attack() << ", D : " << goblin2.get_defense() << endl;
//
...
//	cout << "goblin 1: " << "A:" << goblin.get_attack() << ", D : " << goblin.get_defense() << endl;
//	cout << "goblin 2: " << "A:" << goblin2.get_attack() << ", D : " << goblin2.get_defense() << endl;
//	cout << "goblin king: " << "A:" << goblin3.get_attack() << ", D : " << goblin3.get_defense() << endl;
//
//
//	return 0;
//}